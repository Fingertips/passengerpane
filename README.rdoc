...
* Added Phusion Union Station support
...
* Rewrite in Cocoa for 64-bit support
* Command-line utility
  * ~/Library/PreferencePanes/Passenger.prefPane/Contents/Resources/bin/ppane --help
  * Separately installable with RubyGems: gem install ppane
* Fixed a bug that left hostnames in the Directory services after
  unregistering apps.
